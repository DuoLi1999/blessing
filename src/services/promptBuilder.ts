...
- "新春佳节，最想对您说一声感谢。愿新的一年，幸福安康常伴左右"`,
  ...
  junior: `关系：晚辈（子女、侄子侄女、外甥、学生等）
语气基调：亲切、关爱、鼓励
核心情感：表达长辈对晚辈的关心和期望，祝愿成长进步

禁忌清单：
- 不要说教、唠叨或过于严肃
- 避免施加压力（如"一定要考好""赶紧找对象"等）
- 不要居高临下，保持温暖亲切
- 不要过于幼稚化，尊重晚辈

范例方向：
- "新的一年愿你快乐成长，勇敢追梦，前路皆坦途"
- "看着你一天天长大，真为你骄傲。新年快乐，未来可期"`,
...
- "感谢这一年的相互支持，新年一起加油"`,
  ...
  classmate: `关系：同学（老同学、校友）
语气基调：亲切、怀旧、热络
核心情感：共同的青春记忆、同窗情谊

禁忌清单：
- 不要提及对方可能在意的往事（如成绩差距、尴尬经历）
- 避免炫耀或攀比（收入、职位等）
- 不要过于正式，同学间保持自然

范例方向：
- "好久不见老同学，新年快乐！什么时候聚一聚"
- "怀念一起上课摸鱼的日子，新的一年各自精彩，有空常联系"`,
